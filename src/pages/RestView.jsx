...
function RestView() {
  // useParams() hook is used to get parameter passed in the url
  const { id } = useParams()
  ...
  return (
    <>
      <Row className='mt-5 '>
        ...
        <Col md={3}>
          <img src={selectedRestaurant.photograph} alt="" width={'85%'} height={'85%'} className='rounded' />
        </Col>
              ...
              <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                  <ListGroup>
                    ...
                    <ListGroup.Item>Tuseday: {selectedRestaurant.operating_hours.Tuesday}</ListGroup.Item>
